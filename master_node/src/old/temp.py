...
class Controller:
    ...
    def GPP(self):
        ...
        self.path.x, self.path.y, self.path.yaw = makeTarget.path_connect(str(self.start_idx), '32') # 출발노드, 도착노드
...
# obj=message_filters.Subscriber("/darknet_ros/bounding_boxes_c", BoundingBoxes)
